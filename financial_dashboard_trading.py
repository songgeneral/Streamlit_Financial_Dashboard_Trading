...
if choice == '台積電: 2022.1.1 至 2024.4.9':
    start_date = st.text_input('選擇開始日期(日期格式: 2022-01-01), 區間:2022-01-01 至 2024-04-09', '2022-01-01')
    end_date = st.text_input('選擇結束日期 (日期格式: 2024-04-09), 區間:2022-01-01 至 2024-04-09', '2024-04-09')
if choice == '大台指2024.12到期: 2024.1 至 2024.4.9':
    start_date = st.text_input('選擇開始日期(日期格式: 2024-01-01), 區間:2024-01-01 至 2024-04-09', '2024-01-01')
    end_date = st.text_input('選擇結束日期 (日期格式: 2024-04-09), 區間:2024-01-01 至 2024-04-09', '2024-04-09')
